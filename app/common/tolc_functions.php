...
<input type="hidden" id="active_elements" value="<?php print $active_elements ?>">
...
<div id="login_form" title="<?php print gettext('Login')?>">
    ...
    <div id="row_username" class="field_container">
        <label id="lbl_username" for="username" class="required"><?php print gettext('Username') ?></label>
        <input id="username" type="text" autocomplete="off">
    </div>

    <div id="row_password" class="field_container">
        <label id="lbl_password" for="password" class="required"><?php print gettext('Password') ?></label>
        <input id="password" type="password">
    </div>

    <div id="row_language" class="field_container">
        <label  id="lbl_language" for="language" class="required"><?php print gettext('Language') ?></label>
        <select id="language">
            <?php foreach ($a_lang as $lang) {?>
            <option value="<?php print $lang['locale'] ?>"><?php print $lang['lang_intl'] . ' - ' . $lang['lang_local'] . ' - ' . $lang['locale'] ?></option>
            <?php } ?>
        </select>
    </div>
...
<input type="hidden" id="btn_do_login_value" value="<?php print gettext('Login') ?>">
<input type="hidden" id="btn_cancel_login_value" value="<?php print gettext('Cancel') ?>">
<input type="hidden" id="msg_username_required" value="<?php print gettext('Username is required') . '...' ?>">
<input type="hidden" id="msg_password_required" value="<?php print gettext('Password is required') . '...' ?>">
