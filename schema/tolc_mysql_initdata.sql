...
INSERT INTO `www_lookup_data` VALUES (1,1,80,1,'pending registration',10),(2,1,80,2,'active user',20),(3,1,80,3,'inactive user',30),(4,1,19,1,'σε αναμονή για έγγραφή',10),(5,1,19,2,'ενεργός χρήστης',20),(6,1,19,3,'ανενεργός χρήστης',30),(7,2,80,7,'pending publication',10),(8,2,80,8,'published',20),(9,2,80,9,'discarded',30),(10,2,80,10,'removed',40),(11,2,19,7,'σε αναμονή για δημοσίευση',10),(12,2,19,8,'δημοσιευμένο',20),(13,2,19,9,'απορρίφθηκε',30),(14,2,19,10,'απομακρύνθηκε',40);
...
-- Dump completed on 2012-07-08 15:33:51
